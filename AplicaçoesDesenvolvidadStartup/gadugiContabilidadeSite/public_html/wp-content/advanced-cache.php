          ...
          'data' => '[class*=wp-block-ultimate-post-post-slider] .ultp-block-items-wrap:not(.slick-initialized) > .ultp-block-item:not(:first-child)
{
	display: none!important;
        ...
        array (
          'enable' => true,
          'descr' => 'Preloaders',
          'data' => '#preloader, #page_preloader, #page-preloader, #loader-wrapper, #royal_preloader, #loftloader-wrapper, #page-loading, #the7-body > #load,
.rokka-loader, .page-preloader-cover, .apus-page-loading, .medizco-preloder, e-page-transition, .loadercontent, .shadepro-preloader-wrap {
	display: none !important;
}
...
html:not([dir=rtl]) .vc_row[data-vc-full-width-init="false"] {
	left: calc((100% - var(--seraph-accel-client-width)) / 2);
	margin-left: 0;
}

html[dir=rtl] .vc_row[data-vc-full-width-init="false"] {
	right: calc((100% - var(--seraph-accel-client-width)) / 2);
	margin-right: 0;
}

body#the7-body .vc_row:not(.vc_row-has-fill)[data-vc-full-width-init="false"], .vc_row.mpc-row[data-vc-full-width-init="false"] {
...
',
        ...
        array (
          'enable' => true,
          'descr' => 'WPBakery',
          'data' => 'body.seraph-accel-js-lzl-ing-ani .wpb_animate_when_almost_visible {
	opacity: 1 !important;
}

body.seraph-accel-js-lzl-ing-ani .wpb_animate_when_almost_visible.fadeInUp:not(.wpb_start_animation) {
	animation: fadeInUp;
