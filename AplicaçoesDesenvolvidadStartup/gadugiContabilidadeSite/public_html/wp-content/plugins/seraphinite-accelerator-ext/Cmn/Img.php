...
class Img
{
	...
	static function CreateCopyResample( $h, $sizeDst, $rcSrc = null, $rcDst = null, $bgClr = null )
	{
		...
		imagefill( $hNew, 0, 0, imagecolorallocatealpha( $hNew, 0, 0, 0, 127 ) );

		if( $bgClr !== null )
			imagefilledrectangle( $hNew, 0, 0, $sizeDst[ 'cx' ] - 1, $sizeDst[ 'cy' ] - 1, imagecolorallocate( $hNew, ( $bgClr >> 16 ) & 0xFF, ( $bgClr >> 8 ) & 0xFF, $bgClr & 0xFF ) );
